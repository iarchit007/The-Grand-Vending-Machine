...
int main()
{
    ...
    char ch1, ch2, ch3, ch4, ch5, ch6, ch7, ch8, ch9, x, y, z, b, j, k, l, h, i, m, O, o, ch10, ch11, ch12, ch13, ch14, ch15, ch16, ch17, ch18, ch19, ch20, ch21, ch22;
    printf("THE GRAND VENDING MACHINE\n");
    top:
    printf("1. Chocolate ice-cream (₹%d)\n", i1);
    printf("2. Vanilla ice-cream (₹%d)\n", i2);
    printf("3. Butterscotch (₹%d)\n", i3);
    printf("The price of cup and cone is same\n");
        ...
        top1:
            ...
            if (ch3 == 'o' || ch3 == 'O')
            {
                ...
                if (b == 'x' || b == 'y' || b == 'z' || b == 'w')
                {
                    ...
                    printf("Enter O to confirm the order and any other letter to cancel the order.\n", a, b);
                    scanf(" %c", &ch7);
                    if (ch7 == 'o' || ch7 == 'O')
                    {
                    ...
                    else
                    {
                        ...
                        printf("\nDo you want to retry (Enter o for yes and any other letter for no)?\n");
                        scanf(" %c", &ch12);
                        if (ch12 == 'o' || ch12 == 'O')
                        {
                            goto top1;
                        ...
                        {
                            printf("Ok! Your order has been cancelled");
                        }
                    }
                }
                else
